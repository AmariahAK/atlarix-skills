---
name: Cursor rules for Jest development with unit testing
version: 1.0.0
author: community
...
## Source
Synced from https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/jest-unit-testing-cursorrules-prompt-file.mdc.
