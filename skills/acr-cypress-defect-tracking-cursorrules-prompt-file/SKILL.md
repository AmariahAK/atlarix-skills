---
name: Cursor rules for Cypress development with defect tracking
version: 1.0.0
author: community
...
## Source
Synced from https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/cypress-defect-tracking-cursorrules-prompt-file.mdc.
