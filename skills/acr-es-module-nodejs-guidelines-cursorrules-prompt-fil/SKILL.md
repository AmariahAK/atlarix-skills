---
name: Cursor rules for ES Module development with Node
version: 1.0.0
author: community
tags: [cursorrules, node, community]
compatibleModes: [Build, Review, Explore]
atlarixMinVersion: "7.0.0"
---

# Cursor rules for ES Module development with Node

## When to use this skill
Cursor rules for ES Module development with Node.js guidelines.

## Source
Synced from https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/es-module-nodejs-guidelines-cursorrules-prompt-fil.mdc.
