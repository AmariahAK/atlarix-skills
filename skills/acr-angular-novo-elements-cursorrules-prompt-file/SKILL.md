---
name: Cursor rules for Angular development with Novo Elements UI library
version: 1.0.0
author: community
...
## Source
Synced from https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/angular-novo-elements-cursorrules-prompt-file.mdc.
