---
name: Guide Cursor to write modern C++ and CMake code with clear structure, RAII, cons
version: 1.0.0
author: community
...
# Guide Cursor to write modern C++ and CMake code with clear structure, RAII, cons

## When to use this skill
Guide Cursor to write modern C++ and CMake code with clear structure, RAII, const-correctness, and safe error handling.

## Source
Synced from https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/cpp.mdc.
