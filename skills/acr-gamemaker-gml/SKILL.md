---
name: GameMaker Language (GML) rules for scripts, objects, events, rooms, data structu
version: 1.0.0
author: community
...
# GameMaker Language (GML) rules for scripts, objects, events, rooms, data structu

## When to use this skill
GameMaker Language (GML) rules for scripts, objects, events, rooms, data structures, and performance-minded game code

## Source
Synced from https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/gamemaker-gml.mdc.
