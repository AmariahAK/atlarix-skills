---
name: Google Agent Development Kit rules for agents, tools, sessions, memory, artifact
version: 1.0.0
author: community
...
# Google Agent Development Kit rules for agents, tools, sessions, memory, artifact

## When to use this skill
Google Agent Development Kit rules for agents, tools, sessions, memory, artifacts, evaluation, and deployment

## Source
Synced from https://github.com/PatrickJS/awesome-cursorrules/tree/main/rules/google-adk.mdc.
